...
export const SAMPLE_ALIENS: AlienSpecies[] = [
  {
    ...
    threatLevel: 'medium',
    traits: ['Telepathic communication', 'Advanced medical technology', 'Hive mind consciousness', 'Photosensitive eyes', 'No visible ears or nose'],
  ...
  },
  {
    ...
    threatLevel: 'low',
    traits: ['Human-like appearance', 'Spiritual guides', 'Anti-nuclear advocates', 'Longevity — reported lifespans of thousands of years', 'Vegetarian civilization'],
  ...
  },
  {
    ...
    traits: ['Shapeshifting ability', 'Cold-blooded physiology', 'Infrared vision', 'Pheromone-based dominance hierarchy', 'Extreme physical strength'],
  ...
  },
  {
    ...
    threatLevel: 'low',
    traits: ['Photonic travel capability', 'Empathic projection', 'Non-corporeal at will', 'Environmental stewardship', 'Time perception beyond linear'],
  ...
  },
  {
    ...
    threatLevel: 'high',
    traits: ['Extreme height and thin limbs', 'Apparent authority over Greys', 'Rapid movement', 'Strong psychic suppression field', 'Advanced surgical precision'],
  ...
  },
  {
    ...
    threatLevel: 'high',
    traits: ['Immense physical stature', 'Advanced genetic engineering', 'Long temporal perspective (millennia-scale planning)', 'Historical cultural influence', 'Gold extraction technology'],
  ...
  },
  {
    ...
    threatLevel: 'medium',
    traits: ['Memory suppression techniques', 'Appear immediately after sightings', 'Drive vintage black vehicles', 'Show no knowledge of basic cultural norms', 'Unable to blink normally'],
  ...
  },
  {
    ...
    threatLevel: 'low',
    traits: ['Consciousness-based technology', 'Healing and energy medicine', 'Fifth-dimensional awareness', 'Collective non-judgmental intelligence', 'Communication via sacred geometry'],
